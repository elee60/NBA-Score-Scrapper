...
public class PlayerComparator extends Comparator {
	  public PlayerComparator(){
		  ...
		  public String compare(String player1, String player2, String statCategory){
		    ...
		    if(player1Stat.contains("%")) {
		    	player1Stat = player1Stat.substring(0,player1Stat.length()-1);
		    }
		    if(player2Stat.contains("%")) {
		    	player2Stat = player2Stat.substring(0,player2Stat.length()-1);
		    }
		    player1StatNum = Double.parseDouble(player1Stat);
		    player2StatNum = Double.parseDouble(player2Stat);
